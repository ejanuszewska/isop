...
$_POST['email']) : $rekruter->adresEmail; ?>"/>
  </div>
...
else
{
    ...
    $password1 = (isset($_POST['password1']) && $_POST['password1']) ?
        sha1($_POST['password1']) : $rekruter->password;
    $password2 = (isset($_POST['password2']) && $_POST['password2']) ?
        sha1($_POST['password2']) : $rekruter->password;
    $password = ($password1 == $password2) ? $password1 : '';


    if (Rekruter::validateEmailAddr($_POST['email']) && $password)
    {
        $rekruter->adresEmail = $_POST['email'];
        $rekruter->haslo = $password;
        $rekruter->save();
